...
const menuItems = [
  { id: "students", label: "Students", icon: Users, accessTo: ["ADMIN", "FRONTDESK", "ACCOUNTS", "TEACHER", "STORE", "SUPER_ADMIN"] },
  ...
  { id: "tests", label: "Test Reports", icon: FileText, accessTo: ["ADMIN", "FRONTDESK", "TEACHER", "SUPER_ADMIN"] },
  { id: "attendance", label: "Attendance", icon: Calendar, accessTo: ["ADMIN", "FRONTDESK", "TEACHER", "SUPER_ADMIN"] },
