...
const menuItems = [
  ...
  },
  {
    ...
    label: "Batches",
    icon: BookOpen,
    accessTo: ["ADMIN", "FRONTDESK", "STORE", "SUPER_ADMIN"],
  },
  {
    id: "tests",
    label: "Test Reports",
    icon: FileText,
    accessTo: ["ADMIN", "FRONTDESK", "TEACHER", "SUPER_ADMIN"],
  },
  {
    id: "attendance",
    label: "Attendance",
  ...
  },
  {
    ...
    icon: CreditCard,
    accessTo: ["ADMIN", "ACCOUNTS", "SUPER_ADMIN"],
  },
  {
    id: "kits",
    label: "Kit Management",
    icon: Package,
    accessTo: ["ADMIN", "STORE", "SUPER_ADMIN"],
  },
  {
    id: "marks",
    label: "Marks Comparison",
    icon: BarChart3,
    accessTo: ["ADMIN", "TEACHER", "SUPER_ADMIN"],
  },
